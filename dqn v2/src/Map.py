...
class Map(object):
    def __init__(self,origin,destination,iteration,map_file,testing):
    ...
    def reset(self,episode):
        ...
        if(int(episode)>298 and self.testing): # or int(episode)>290):
    ...
    def step(self, action):
        ...
        if(int(self.episode) > 298 and self.testing): # only write the last episode
