...
class Metrics():
    ...
    def drawAstar(self,i,map_file):
        ...
        for line in f:
            ...
            x = int((int(nums[0])*new_size[0]*4)/old_size[0])
            y = int((int(nums[1])*new_size[0]*4)/old_size[1])
...
w.write("Case\tGreen\tTransparent\tRed\tTotal\tGreen\tTransparent\tRed\tTotal\tGreen\tTransparent\tRed\tTotal\n")
#pts = [2,3,7,11,12,14]
for i in range(1,4):
